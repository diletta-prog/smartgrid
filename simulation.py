...
class Simulation:
    ...
    def midnight(self, attributes):
        ...
        """"---> se è in valore base, rimane al valore base"""
        ...
        #schedulo la prossima mezzanotte


        self.fes.put(
            (self.clock + 24 * 3600, self.arrival, None))
    ...
    def sunrise(self, attributes):
        ...
        tramonto """
        """azzerare tutto"""
        for item in self.city.allLamps():
            item.setLevel(0, self.clock)
            item.setBusy(-1)


        lamp = self.city.randomLamp()
        self.fes.put((self.clock+12*3600, self.arrival, (lamp, lamp.randomNeigh(), randint(3, 10), 1)))  # primo elemento
        # schedule next sunrise

        self.fes.put(
            (self.clock + 24 * 3600, self.sunrise, None))
    ...
    def sunset(self, attibutes):
        ...
        self.fes.put(
            (self.clock + 24 * 3600, self.sunset, None))
